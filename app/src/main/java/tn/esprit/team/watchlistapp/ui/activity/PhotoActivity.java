...
import  tn.esprit.team.watchlistapp.ui.adapter.PhotoAdapter;
import  tn.esprit.team.watchlistapp.ui.adapter.PhotoAdapter.OnPhotoClickListener;
                  ...
                  //  public void onResponse(JSONObject object) {
                       try {
                           // JSONArray backdrops = object.getJSONArray("backdrops");
                            for (int i = 0; i < 3; i++) {
                               String file_path= "https://images.pexels.com/photos/4825/red-love-romantic-flowers.jpg?h=350&auto=compress";
                                adapter.photoList.add(file_path);
                            }
                            onDownloadSuccessful();
                        } catch (Exception ex) {
                            onDownloadFailed();
...
//                });
   ...
   // }
    ...
    public void onPhotoClicked(int position) {
        String url = adapter.photoList.get(position);
